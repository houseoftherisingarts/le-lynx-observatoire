...
verifier('un passant lit les interrupteurs', () => assertSucceeds(getDoc(doc(passant, 'config', 'modules'))));
verifier('un membre ne change pas les interrupteurs', () => assertFails(setDoc(doc(bea, 'config', 'modules'), { engagement: true })));
