...
export const SEED_VERSION = "2026-09-01-b";
...
export const SEED_NEWS: SeedItem[] = [
  ...
  },
  {
    ...
    summary:
      "Le 24 août 2026 à Val-d'Or, la ministre des Ressources naturelles et des Forêts Kateri Champagne Jourdain annonce un engagement électoral : ajouter 38 M$ aux 38 M$ déjà prévus au Programme de partage des redevances sur les ressources naturelles, pour une enveloppe annuelle de 76 M$ dès 2027, et prolonger le programme jusqu'en 2031. Le gouvernement choisit donc de mieux partager la rente minière plutôt que de suspendre des titres.",
  ...
  },
  {
    ...
    summary:
      "L'ordonnance intérimaire de la Cour suprême de la Colombie-Britannique fixe la clôture des registres au 19 août 2026 pour déterminer qui reçoit l'avis et peut voter à l'assemblée extraordinaire du 23 septembre. Le vote porte sur l'acquisition de Lomiko Metals par Global Battery Materials.",
    category: "miniere",
  ...
  },
  {
    ...
    summary:
      "Le 10 août 2026, l'APLS publie un billet de bilan un an après le référendum consultatif du 31 août 2025 tenu dans cinq municipalités de la Petite-Nation. L'association tient un dossier La Loutre avec une revue de presse classée par année depuis 2007, et le billet existe aussi en anglais.",
    category: "mobilisation",
    source: "apls.ca",
  ...
  },
  {
    ...
    summary:
      "Le 8 mai 2026, Lomiko dépose le rapport technique NI 43-101 de niveau préfaisabilité et l'estimation des ressources mise à jour, préparés par DRA Americas. Les réserves probables atteignent 46,8 Mt à 4,79 pour cent de carbone graphitique, soit 2,24 Mt de graphite contenu en date de février 2026. Le projet double par rapport à l'étude précédente, et sa durée de vie passe de quinze à vingt-huit ans.",
    category: "miniere",
    source: "lomiko.com",
  ...
  },
  {
    ...
    summary:
      "Le 20 avril 2026, l'Alliance publie le texte de la résolution adoptée par le conseil de la MRC de Papineau. Le conseil déclare que l'activité minière, tant en phase d'exploration qu'en phase d'exploitation, est incompatible avec la vocation du territoire de la MRC, avec son modèle de développement durable, avec la protection de ses ressources naturelles et avec le maintien de la qualité de vie de ses communautés.",
    category: "municipal",
    source: "alliancepetitenation.org",
...
export const SEED_EVENTS = [
  {
    ...
    description:
      "Assemblée extraordinaire tenue chez Fasken Martineau DuMoulin, à Vancouver, à 10 h heure de Vancouver. Le vote décide si le projet La Loutre change de mains pour environ 11 M$. La clôture de la transaction est attendue au quatrième trimestre.",
  ...
  },
  {
    ...
    description:
      "L'Alliance a décidé de faire de la suspension des claims un enjeu de campagne dans Papineau. C'est la date où la question minière se pose directement aux personnes qui sollicitent un mandat.",
