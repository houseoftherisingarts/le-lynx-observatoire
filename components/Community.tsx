        ...
        <div className="w-full max-w-6xl mx-auto pb-20 animate-fade-in relative">
            ...
            {isAuthModalOpen && (
                <Connexion
                    language={language}
                    enModale
                    onFerme={() => setIsAuthModalOpen(false)}
                />
            )}

            {/* Première entrée dans le réseau : la fiche prend un visage. */}
                        ...
                        {authState.isAuthenticated ? (
                            ...
                            <div className="mt-2 flex flex-wrap items-center gap-3">
                                <button
                                    ...
                                    className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full text-[11px] font-bold uppercase tracking-widest transition-colors"
                                >
                                    Créer un compte
                                </button>
                                <button
                                    onClick={() => setIsAuthModalOpen(true)}
                                    className="text-slate-500 hover:text-white transition-colors text-[11px] font-bold uppercase tracking-widest underline decoration-dotted underline-offset-4"
                                >
                                    Me connecter
                                </button>
                            </div>
